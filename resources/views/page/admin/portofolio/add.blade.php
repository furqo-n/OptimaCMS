@extends('layouts.base_admin.base_dashboard') @section('judul', 'Tambah Portofolio')
        ...
        <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName" name="title"
                                    ...
                                    placeholder="Masukkan Judul Portofolio" value="{{ old('title') }}" required="required"
                                    autocomplete="off">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputCategory" name="category"
                                    ...
                                    placeholder="Masukkan Kategori (contoh: Web, Mobile, Desain)"
                                    value="{{ old('category') }}" required="required" autocomplete="off">
                                @error('category')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_produk" id="kategori_produk"
                                    ...
                                    <option value="Produk Aplikasi Android (Mobile App)" {{ old('kategori_produk') == 'Produk Aplikasi Android (Mobile App)' ? 'selected' : '' }}>Produk Aplikasi Android (Mobile
                                        App)</option>
                                    <option value="Produk Sistem Sektor Pemerintahan" {{ old('kategori_produk') == 'Produk Sistem Sektor Pemerintahan' ? 'selected' : '' }}>Produk Sistem Sektor Pemerintahan
                                    </option>
                                    <option value="Produk Sistem Sektor Swasta" {{ old('kategori_produk') == 'Produk Sistem Sektor Swasta' ? 'selected' : '' }}>Produk Sistem Sektor Swasta</option>
                                    <option value="Produk Sistem OIMS - SIMRS" {{ old('kategori_produk') == 'Produk Sistem OIMS - SIMRS' ? 'selected' : '' }}>Produk Sistem OIMS - SIMRS</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="deskripsi_panjang" name="deskripsi_panjang" class="form-control"
                                    rows="4">{{ old('deskripsi_panjang') }}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="tools_pengembangan" name="tools_pengembangan" class="form-control"
                                    placeholder="Contoh: Laravel, VueJS, MySQL" value="{{ old('tools_pengembangan') }}">
                            </div>
                            <div class="form-group">
                                <label for="deskripsi_keunggulan_singkat">Deskripsi Keunggulan Singkat</label>
                                <input type="text" id="deskripsi_keunggulan_singkat" name="deskripsi_keunggulan_singkat"
                                    ...
                                    value="{{ old('deskripsi_keunggulan_singkat') }}">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputFoto">Foto Portofolio</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input @error('image') is-invalid @enderror"
                                            id="inputFoto" name="image" accept="image/*">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <input type="submit" value="Tambah Portofolio" class="btn btn-success float-right">
                </div>
            </div>
        </form>
    </section>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#add-advantage').on('click', function (e) {
                e.preventDefault();
                console.log('Tambah Keunggulan Clicked');
                let html = `
                                <div class="advantage-row row mb-3">
                                    <div class="col-md-3">
                                        <input type="text" name="advantages[${advantageIndex}][icon]" class="form-control" placeholder="Icon (fa fa-check)">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" name="advantages[${advantageIndex}][title]" class="form-control" placeholder="Judul Keunggulan">
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" name="advantages[${advantageIndex}][text]" class="form-control" placeholder="Deskripsi Singkat">
                                    </div>
                                    <div class="col-md-1">
